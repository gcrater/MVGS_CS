...
public class FileChooser {
    ...
    public static String getMediaDirectory() {
        ...
        try {
            ...
            Class currClass = Class.forName("PictureLab.FileChooser");
            URL classURL = currClass.getResource("PictureLab.FileChooser.class");
            // URL fileURL = new URL(classURL, "../images/");
            URL fileURL = new URL(classURL, "file://C:\\Users\\Student\\eclipse-workspace\\grace\\MVGS_CS\\images\\");
